...
final class AudioRecorder {
    ...
    private let bufferQueue = DispatchQueue(label: "com.whispr.audiobuffer")
    ...
    func warmUp() throws {
        ...
        NSLog("[Whispr] AudioRecorder: warmed up, input format=\(inputFormat), sampleRate=\(inputFormat.sampleRate)")
    }
