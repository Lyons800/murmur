...
final class AudioRecorder {
    ...
    private let bufferQueue = DispatchQueue(label: "audio.sotto.audiobuffer")
    ...
    func warmUp() throws {
        ...
        NSLog("[Sotto] AudioRecorder: warmed up, input format=\(inputFormat), sampleRate=\(inputFormat.sampleRate)")
    }
